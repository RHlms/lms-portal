...
export default async function handler(req, res) {
  ...
  try {
    ...
    const data = {
      ...
      oifReceived:          isChecked(fields, FIELD_IDS.oifReceived),
      offerDocsReceived:    isChecked(fields, FIELD_IDS.offerDocsReceived),
      offer1MiscReceived:   isChecked(fields, FIELD_IDS.offer1MiscReceived),
      oif2Received:         isChecked(fields, FIELD_IDS.oif2Received),
      offerDocs2Received:   isChecked(fields, FIELD_IDS.offerDocs2Received),
      offer2MiscReceived:   isChecked(fields, FIELD_IDS.offer2MiscReceived),
